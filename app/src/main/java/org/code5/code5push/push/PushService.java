...
import org.code5.code5push.LaunchActivity;
import org.code5.code5push.MainActivity;
...
public class PushService extends FirebaseMessagingService {
    ...
    private void handleNow(String message) {
        ...
        msg.setDate(dateFormat.format(date));
